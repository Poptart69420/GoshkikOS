...
/// @brief delete an PMLT4 and free all used pages by it (only by the table not
/// the physical pages the PT point to)
...
/// @param flags flag to use for the virtual page (eg readonly, not
/// executable...)
void map_page(addrspace_t PMLT4, uintptr_t physical_page,
              uintptr_t virtual_page, uint64_t flags);
