...
/// @param offset address to read (inside the configuration space) MUST BE
/// ALIGNED
/// @return the dword read from the configuration space
uint32_t pci_read_config_dword(uint8_t bus, uint8_t device, uint8_t function,
                               uint8_t offset);
...
uint16_t pci_read_config_word(uint8_t bus, uint8_t device, uint8_t function,
                              uint8_t offset);
...
/// @return the word read from the configuration space
uint8_t pci_read_config_byte(uint8_t bus, uint8_t device, uint8_t function,
                             uint8_t offset);

void pci_write_config_dword(uint8_t bus, uint8_t device, uint8_t function,
                            uint8_t offset, uint32_t data);
void pci_write_config_word(uint8_t bus, uint8_t device, uint8_t function,
                           uint8_t offset, uint16_t data);
void pci_write_config_byte(uint8_t bus, uint8_t device, uint8_t function,
